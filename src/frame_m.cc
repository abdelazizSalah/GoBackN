...
// }
/*
    This is a default constructor to be able to instaniate some objects.
*/
...
unsigned int Frame_Base::getHeader() const
{
    return this->Header;
}

void Frame_Base::setHeader(unsigned int Header)
{
    this->Header = Header;
}
...
int Frame_Base::getFrameType() const
{
    return this->FrameType;
}

void Frame_Base::setFrameType(int FrameType)
{
    this->FrameType = FrameType;
}

unsigned int Frame_Base::getAckNum() const
{
    return this->AckNum;
}

void Frame_Base::setAckNum(unsigned int AckNum)
{
    this->AckNum = AckNum;
}
...
const char *FrameDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "unsigned int", // FIELD_Header
        "string",       // FIELD_Payload
        "char",         // FIELD_Trailer
        "int",          // FIELD_FrameType
        "unsigned int", // FIELD_AckNum
    };
...
std::string FrameDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    {
    case FIELD_Header:
        return ulong2string(pp->getHeader());
    case FIELD_Payload:
    ...
    case FIELD_AckNum:
        return ulong2string(pp->getAckNum());
    default:
        return "";
    }
}
...
void FrameDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    {
    case FIELD_Header:
        pp->setHeader(string2ulong(value));
        break;
    case FIELD_Payload:
        pp->setPayload((value));
        break;
    ...
    case FIELD_FrameType:
        ...
        break;
    case FIELD_AckNum:
        pp->setAckNum(string2ulong(value));
        break;
    default:
...
omnetpp::cValue FrameDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    {
    case FIELD_Header:
        return (omnetpp::intval_t)(pp->getHeader());
    case FIELD_Payload:
    ...
    case FIELD_AckNum:
        return (omnetpp::intval_t)(pp->getAckNum());
    default:
...
void FrameDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue &value) const
{
    ...
    {
    case FIELD_Header:
        pp->setHeader(omnetpp::checked_int_cast<unsigned int>(value.intValue()));
        break;
    case FIELD_Payload:
    ...
    case FIELD_FrameType:
        ...
        break;
    case FIELD_AckNum:
        pp->setAckNum(omnetpp::checked_int_cast<unsigned int>(value.intValue()));
        break;
    default:
        throw omnetpp::cRuntimeError("Cannot set field %d of class 'Frame_Base'", field);
    }
